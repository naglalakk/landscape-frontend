  ...
  inputs = {
    ...
    "affjax" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8e1bd696d3bfa6feba7017daa65c4474aab5da42";
    ...
    "argonaut" = pkgs.stdenv.mkDerivation {
        name = "argonaut";
        version = "2b81ce16b4c0e8cac0be88b4bf616523b6ddda56";
        src = pkgs.fetchgit {
          url = "https://github.com/purescript-contrib/purescript-argonaut";
    ...
    "argonaut-codecs" = pkgs.stdenv.mkDerivation {
        ...
        version = "9b00fcc6b04bd999d3fd3b9de2ae830bff473a71";
        src = pkgs.fetchgit {
    ...
    "argonaut-traversals" = pkgs.stdenv.mkDerivation {
        ...
        version = "9543b517011a4dbc66dfd5cd4d8d774aa620b764";
        src = pkgs.fetchgit {
    ...
    "elasticsearch" = pkgs.stdenv.mkDerivation {
        name = "elasticsearch";
        version = "06b48a3df3ba4c85406e120cff457b680d4aa297";
        src = pkgs.fetchgit {
          url = "https://github.com/naglalakk/purescript-elasticsearch";
          rev = "06b48a3df3ba4c85406e120cff457b680d4aa297";
          sha256 = "0r867k1n4q0q3n0py0m3igmkqhr2f5c70g3sj30nfpxd2nxfm83x";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
    ...
    "halogen-formless" = pkgs.stdenv.mkDerivation {
        ...
        version = "07f877c99420b33dd8813cbf8ab2c30ca40bbb49";
        src = pkgs.fetchgit {
          url = "https://github.com/thomashoneyman/purescript-halogen-formless.git";
          rev = "07f877c99420b33dd8813cbf8ab2c30ca40bbb49";
          sha256 = "1w7mvlsx7c767ldpmdzyan0krhv4032azkhhbjw2x52dc5cxsyhn";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
    ...
    "halogen-hooks" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "c3b4730f9a5e17dcc3f50d2629bed6d09c34a680";
          sha256 = "0a5ylw95bwybinlaby477v0n1axq665wcs7i1rj2lnk58viv1vpw";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
    ...
    "slug" = pkgs.stdenv.mkDerivation {
        name = "slug";
        version = "96815a42dd1f572774bc54c606a4741b0dc64c2f";
        src = pkgs.fetchgit {
    ...
    "timestamp" = pkgs.stdenv.mkDerivation {
        name = "timestamp";
        version = "fc494eef323beb9e084d31c2b78fcd197de36c10";
        src = pkgs.fetchgit {
          url = "https://github.com/naglalakk/purescript-timestamp";
          rev = "fc494eef323beb9e084d31c2b78fcd197de36c10";
          sha256 = "0if4qb1hnjp0m5yqhih60qm2f6jigw9g59divai97a47i24bjirx";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
    ...
    "uuid" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "ac687a7d23c212194a76857b7487b3cd3e9d7c4a";
          sha256 = "178mc0gavxf999ipjgbmf1nrsdw055ibbgwals6vxpkx9j7kp6qp";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
