...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Data.BlogPost"] = $PS["Data.BlogPost"] || {};
  var exports = $PS["Data.BlogPost"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Newtype = $PS["Data.Newtype"];          
  var BlogPostId = function (x) {
      return x;
  };
  var newtypeBlogPostId = new Data_Newtype.Newtype(function (n) {
      return n;
  }, BlogPostId);
  var eqBlogPostId = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x === y;
      };
  });
  exports["newtypeBlogPostId"] = newtypeBlogPostId;
  exports["eqBlogPostId"] = eqBlogPostId;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Utils.Route"] = $PS["Utils.Route"] || {};
  var exports = $PS["Utils.Route"];
  var Data_BlogPost = $PS["Data.BlogPost"];
  var Data_Lens_Iso_Newtype = $PS["Data.Lens.Iso.Newtype"];
  var Routing_Duplex = $PS["Routing.Duplex"];                
  var blogPostId = Data_Lens_Iso_Newtype["_Newtype"](Data_BlogPost.newtypeBlogPostId)(Data_BlogPost.newtypeBlogPostId)(Routing_Duplex.profunctorRouteDuplex)(Routing_Duplex["int"](Routing_Duplex.segment));
  exports["blogPostId"] = blogPostId;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  ...
  var Utils_Route = $PS["Utils.Route"];                
  var Home = (function () {
      function Home() {
  ...
  var AdminHome = (function () {
      ...
      AdminHome.value = new AdminHome();
      return AdminHome;
  })();
  var AdminBlogPosts = (function () {
      function AdminBlogPosts() {

      };
      AdminBlogPosts.value = new AdminBlogPosts();
      return AdminBlogPosts;
  })();
  var AdminBlogPost = (function () {
      function AdminBlogPost(value0) {
          this.value0 = value0;
      };
      AdminBlogPost.create = function (value0) {
          return new AdminBlogPost(value0);
      };
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof AdminHome) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
      };
      if (x instanceof AdminBlogPosts) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value)));
      };
      if (x instanceof AdminBlogPost) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(x.value0)));
      };
      throw new Error("Failed pattern match at Data.Route (line 20, column 1 - line 20, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Home.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return AdminHome.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return AdminBlogPosts.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inr)) {
          return new AdminBlogPost(x.value0.value0.value0);
      };
      throw new Error("Failed pattern match at Data.Route (line 20, column 1 - line 20, column 48): " + [ x.constructor.name ]);
  });
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      AdminHome: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("admin")(Routing_Duplex_Generic.noArgs),
      AdminBlogPosts: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("admin")(Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("posts")(Routing_Duplex_Generic.noArgs)),
      AdminBlogPost: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteArgument))("admin")(Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteAll))("posts")(Utils_Route.blogPostId))
  }));     
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof AdminHome && y instanceof AdminHome) {
              return true;
          };
          if (x instanceof AdminBlogPosts && y instanceof AdminBlogPosts) {
              return true;
          };
          if (x instanceof AdminBlogPost && y instanceof AdminBlogPost) {
              return Data_Eq.eq(Data_BlogPost.eqBlogPostId)(x.value0)(y.value0);
          };
          return false;
      };
  });
  ...
  exports["AdminBlogPost"] = AdminBlogPost;
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Resource.BlogPost"] = $PS["Resource.BlogPost"] || {};
  var exports = $PS["Resource.BlogPost"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var ManageBlogPost = function (Monad0, createBlogPost, deleteBlogPost, getBlogPost, getBlogPosts, updateBlogPost) {
      this.Monad0 = Monad0;
      this.createBlogPost = createBlogPost;
      this.deleteBlogPost = deleteBlogPost;
      this.getBlogPost = getBlogPost;
      this.getBlogPosts = getBlogPosts;
      this.updateBlogPost = updateBlogPost;
  };
  var updateBlogPost = function (dict) {
      return dict.updateBlogPost;
  };
  var getBlogPosts = function (dict) {
      return dict.getBlogPosts;
  };
  var getBlogPost = function (dict) {
      return dict.getBlogPost;
  };
  var deleteBlogPost = function (dict) {
      return dict.deleteBlogPost;
  };
  var createBlogPost = function (dict) {
      return dict.createBlogPost;
  };
  var manageBlogPostHalogenM = function (dictManageBlogPost) {
      return new ManageBlogPost(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, (function () {
          var $1 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictManageBlogPost.Monad0());
          var $2 = createBlogPost(dictManageBlogPost);
          return function ($3) {
              return $1($2($3));
          };
      })(), (function () {
          var $4 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictManageBlogPost.Monad0());
          var $5 = deleteBlogPost(dictManageBlogPost);
          return function ($6) {
              return $4($5($6));
          };
      })(), (function () {
          var $7 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictManageBlogPost.Monad0());
          var $8 = getBlogPost(dictManageBlogPost);
          return function ($9) {
              return $7($8($9));
          };
      })(), (function () {
          var $10 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictManageBlogPost.Monad0());
          var $11 = getBlogPosts(dictManageBlogPost);
          return function ($12) {
              return $10($11($12));
          };
      })(), (function () {
          var $13 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictManageBlogPost.Monad0());
          var $14 = updateBlogPost(dictManageBlogPost);
          return function ($15) {
              return $13($14($15));
          };
      })());
  ...
  exports["ManageBlogPost"] = ManageBlogPost;
  exports["manageBlogPostHalogenM"] = manageBlogPostHalogenM;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var Resource_BlogPost = $PS["Resource.BlogPost"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  ...
  var navigateAppM = new Capability_Navigate.Navigate(function () {
      ...
      var $7 = Effect_Class.liftEffect(monadEffectAppM);
      var $8 = Routing_Duplex.print(Data_Route.routeCodec);
      return function ($9) {
          return $7(Routing_Hash.setHash($8($9)));
      };
  })());
  ...
  var manageBlogPostAppM = new Resource_BlogPost.ManageBlogPost(function () {
      return monadAppM;
  }, function (post) {
      return Control_Applicative.pure(applicativeAppM)(Data_Maybe.Nothing.value);
  }, function (post) {
      return Control_Applicative.pure(applicativeAppM)(Data_Unit.unit);
  }, function (postId) {
      return Control_Applicative.pure(applicativeAppM)(Data_Maybe.Nothing.value);
  }, function (pagination) {
      return Control_Applicative.pure(applicativeAppM)([  ]);
  }, function (post) {
      return Control_Applicative.pure(applicativeAppM)(Data_Maybe.Nothing.value);
  });
  ...
  exports["manageBlogPostAppM"] = manageBlogPostAppM;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Component.HTML.Utils"] = $PS["Component.HTML.Utils"] || {};
  var exports = $PS["Component.HTML.Utils"];
  var Data_Route = $PS["Data.Route"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Component.HTML.Admin"] = $PS["Component.HTML.Admin"] || {};
  var exports = $PS["Component.HTML.Admin"];
  var Component_HTML_Utils = $PS["Component.HTML.Utils"];
  var Data_Route = $PS["Data.Route"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];                
  var menuLink = function (route) {
      return function (txt) {
          return Halogen_HTML_Elements.li([ Component_HTML_Utils.css("admin-menu-item") ])([ Halogen_HTML_Elements.a([ Component_HTML_Utils.safeHref(route) ])([ Halogen_HTML_Core.text(txt) ]) ]);
      };
  };
  var adminMenu = Halogen_HTML_Elements.div([ Component_HTML_Utils.css("admin-menu") ])([ Halogen_HTML_Elements.ul([  ])([ menuLink(Data_Route.AdminHome.value)("Home"), menuLink(Data_Route.AdminBlogPosts.value)("Posts") ]) ]);
  var withAdmin = function (content) {
      return Halogen_HTML_Elements.div([ Component_HTML_Utils.css("admin-container") ])([ adminMenu, Halogen_HTML_Elements.div([ Component_HTML_Utils.css("content") ])([ content ]) ]);
  };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Page.Admin.BlogPost"] = $PS["Page.Admin.BlogPost"] || {};
  var exports = $PS["Page.Admin.BlogPost"];
  var Component_HTML_Admin = $PS["Component.HTML.Admin"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var LoadBlogPost = (function () {
      function LoadBlogPost(value0) {
          this.value0 = value0;
      };
      LoadBlogPost.create = function (value0) {
          return new LoadBlogPost(value0);
      };
      return LoadBlogPost;
  })();
  var initialState = function (inp) {
      return {
          ...
          blogPost: Data_Maybe.Nothing.value
      };
  };
  var component = function (dictManageBlogPost) {
      return function (dictNavigate) {
          var render = function (state) {
              return Halogen_HTML_Elements.div([  ])([ Component_HTML_Admin.withAdmin(Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("Post") ]) ])) ]);
          };
          var handleAction = function (v) {
              if (v instanceof Initialize) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.fork(handleAction(new LoadBlogPost(v1.blogPostId))));
                  });
              };
              if (v instanceof LoadBlogPost) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Resource_BlogPost.getBlogPost(Resource_BlogPost.manageBlogPostHalogenM(dictManageBlogPost))(v.value0))(function (v1) {
              ...
              throw new Error("Failed pattern match at Page.Admin.BlogPost (line 65, column 18 - line 74, column 38): " + [ v.constructor.name ]);
          };
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Component.Table"] = $PS["Component.Table"] || {};
  var exports = $PS["Component.Table"];
  var Component_HTML_Utils = $PS["Component.HTML.Utils"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var UpdateRow = (function () {
      function UpdateRow(value0) {
          this.value0 = value0;
      };
      UpdateRow.create = function (value0) {
          return new UpdateRow(value0);
      };
      return UpdateRow;
  })();
  var DeleteRow = (function () {
      function DeleteRow(value0) {
          this.value0 = value0;
      };
      DeleteRow.create = function (value0) {
          return new DeleteRow(value0);
      };
      return DeleteRow;
  })();
  var UpdateClicked = (function () {
      function UpdateClicked(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateClicked.create = function (value0) {
          return function (value1) {
              return new UpdateClicked(value0, value1);
          };
      };
      return UpdateClicked;
  })();
  var DeleteClicked = (function () {
      function DeleteClicked(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DeleteClicked.create = function (value0) {
          return function (value1) {
              return new DeleteClicked(value0, value1);
          };
      };
  ...
  var component = function (dictMonadEffect) {
      var tableRow = function (row) {
          return Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Core.text(row.label) ]), Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Events.onClick(function (e) {
              return Data_Maybe.Just.create(new UpdateClicked(e, row));
          }), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Elements.i([ Component_HTML_Utils.css("fas fa-pencil-alt") ])([  ]) ]) ]), Halogen_HTML_Elements.td([  ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Events.onClick(function (e) {
              return Data_Maybe.Just.create(new DeleteClicked(e, row));
          }), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Elements.i([ Component_HTML_Utils.css("fas fa-trash") ])([  ]) ]) ]) ]);
      };
      var tableHeader = function (col) {
          return Halogen_HTML_Elements.th([  ])([ Halogen_HTML_Core.text(col) ]);
      };
      var render = function (state) {
          return Halogen_HTML_Elements.table([ Component_HTML_Utils.css("responsive-table") ])([ Halogen_HTML_Elements.thead([  ])([ Halogen_HTML_Elements.tr([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(state.headers)(tableHeader)) ]), Halogen_HTML_Elements.tbody([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(state.rows)(tableRow)) ]);
      };
      var initialState = function (inp) {
          return {
              rows: inp.rows,
      ...
      var handleAction = function (v) {
          if (v instanceof UpdateClicked) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(function () {
                  return Halogen_Query_HalogenM.raise(new UpdateRow(v.value1));
              });
          };
          if (v instanceof DeleteClicked) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value0))))(function () {
                  return Halogen_Query_HalogenM.raise(new DeleteRow(v.value1));
              });
          };
          if (v instanceof Receive) {
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0);
          };
          throw new Error("Failed pattern match at Component.Table (line 62, column 20 - line 69, column 37): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Page.Admin.BlogPosts"] = $PS["Page.Admin.BlogPosts"] || {};
  var exports = $PS["Page.Admin.BlogPosts"];
  var Capability_Navigate = $PS["Capability.Navigate"];
  var Component_HTML_Admin = $PS["Component.HTML.Admin"];
  var Component_HTML_Utils = $PS["Component.HTML.Utils"];
  var Component_Table = $PS["Component.Table"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  var Data_BlogPost = $PS["Data.BlogPost"];
  ...
  var LoadBlogPosts = (function () {
      function LoadBlogPosts(value0) {
          this.value0 = value0;
      };
      LoadBlogPosts.create = function (value0) {
          return new LoadBlogPosts(value0);
      };
      return LoadBlogPosts;
  })();
  var HandleTableAction = (function () {
      function HandleTableAction(value0) {
          this.value0 = value0;
      };
      HandleTableAction.create = function (value0) {
          return new HandleTableAction(value0);
      };
      return HandleTableAction;
  })();
  var NavigateToBlogPost = (function () {
      function NavigateToBlogPost(value0) {
          this.value0 = value0;
      };
      NavigateToBlogPost.create = function (value0) {
          return new NavigateToBlogPost(value0);
      };
      return NavigateToBlogPost;
  })();
  var initialState = {
      blogPosts: [  ]
  };
  var component = function (dictManageBlogPost) {
      return function (dictMonadEffect) {
          return function (dictNavigate) {
              var render = function (state) {
                  var tableSlot = function (h) {
                      return function (r) {
                          return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                              return "table";
                          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Component_Table.component(dictMonadEffect))({
                              rows: r,
                              headers: h
                          })(function ($31) {
                              return Data_Maybe.Just.create(HandleTableAction.create($31));
                          });
                      };
                  };
                  var rows = function (posts) {
                      return Data_Functor.map(Data_Functor.functorArray)(function (v) {
                          return {
                              id: Data_Newtype.unwrap(Data_BlogPost.newtypeBlogPostId)(v.id),
                              label: v.title
                          };
                      })(posts);
                  };
                  var headers = [ "Title", "Update", "Delete" ];
                  return Halogen_HTML_Elements.div([  ])([ Component_HTML_Admin.withAdmin(Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Component_HTML_Utils.css("top-bar") ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text("Posts") ]), Halogen_HTML_Elements.button([ Component_HTML_Utils.css("button"), Halogen_HTML_Events.onClick(function (v) {
                      return Data_Maybe.Just.create(NavigateToBlogPost.create(0));
                  }) ])([ Halogen_HTML_Core.text("+ New Post") ]) ]), tableSlot(headers)(rows(state.blogPosts)) ])) ]);
              };
              var handleAction = function (v) {
                  if (v instanceof Initialize) {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.fork(handleAction(new LoadBlogPosts({
                          page: new Data_Maybe.Just(1),
                          perPage: new Data_Maybe.Just(25)
                      }))));
                  };
                  if (v instanceof LoadBlogPosts) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Resource_BlogPost.getBlogPosts(Resource_BlogPost.manageBlogPostHalogenM(dictManageBlogPost))(v.value0))(function (v1) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $17 = {};
                              for (var $18 in v2) {
                  ...
                  if (v instanceof HandleTableAction) {
                      if (v.value0 instanceof Component_Table.UpdateRow) {
                          return Capability_Navigate.navigate(Capability_Navigate.navigateHalogenM(dictNavigate))(Data_Route.AdminBlogPost.create(v.value0.value0.id));
                      };
                      if (v.value0 instanceof Component_Table.DeleteRow) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Resource_BlogPost.deleteBlogPost(Resource_BlogPost.manageBlogPostHalogenM(dictManageBlogPost))(v.value0.value0.id))(function (v1) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                  var posts = Data_Array.filter(function (v3) {
                                      return Data_Newtype.unwrap(Data_BlogPost.newtypeBlogPostId)(v3.id) !== v.value0.value0.id;
                                  })(v2.blogPosts);
                      ...
                      throw new Error("Failed pattern match at Page.Admin.BlogPosts (line 77, column 7 - line 85, column 44): " + [ v.value0.constructor.name ]);
                  };
                  if (v instanceof NavigateToBlogPost) {
                      return Capability_Navigate.navigate(Capability_Navigate.navigateHalogenM(dictNavigate))(new Data_Route.AdminBlogPost(v.value0));
                  };
                  throw new Error("Failed pattern match at Page.Admin.BlogPosts (line 66, column 18 - line 88, column 44): " + [ v.constructor.name ]);
              };
              return Halogen_Component.mkComponent({
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Page.Admin.Home"] = $PS["Page.Admin.Home"] || {};
  var exports = $PS["Page.Admin.Home"];
  var Component_HTML_Admin = $PS["Component.HTML.Admin"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([  ])([ Component_HTML_Admin.withAdmin(Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Testing") ])) ]);
      };
      var handleAction = function (v) {
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Timestamp"] = $PS["Timestamp"] || {};
  var exports = $PS["Timestamp"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Formatter_DateTime = $PS["Data.Formatter.DateTime"];
  var Data_List = $PS["Data.List"];
  var dateFormatter = Data_List.fromFoldable(Data_Foldable.foldableArray)([ Data_Formatter_DateTime.DayOfMonthTwoDigits.value, new Data_Formatter_DateTime.Placeholder("."), Data_Formatter_DateTime.MonthTwoDigits.value, new Data_Formatter_DateTime.Placeholder("."), Data_Formatter_DateTime.YearTwoDigits.value ]);
  var formatToDateStr = function (v) {
      return Data_Formatter_DateTime.format(dateFormatter)(v.value0);
  };
  exports["formatToDateStr"] = formatToDateStr;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  ...
  var component = function (dictManageBlogPost) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Component_HTML_Utils.css("posts-container") ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Halogen_HTML_Elements.div([ Component_HTML_Utils.css("post") ])([ Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text(v.title) ]), Halogen_HTML_Elements.div([ Component_HTML_Utils.css("post-date") ])([ Halogen_HTML_Core.text(Timestamp.formatToDateStr(v.publishTime)) ]), Halogen_HTML_Elements.div([ Component_HTML_Utils.css("post-content") ])([ Halogen_HTML_Core.text(v.content) ]) ]);
          })(state.blogPosts));
      };
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Resource_BlogPost.getBlogPosts(Resource_BlogPost.manageBlogPostHalogenM(dictManageBlogPost))({
              page: new Data_Maybe.Just(1),
              perPage: new Data_Maybe.Just(25)
          }))(function (v1) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
...
(function($PS) {
  ...
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Page_Admin_BlogPost = $PS["Page.Admin.BlogPost"];
  var Page_Admin_BlogPosts = $PS["Page.Admin.BlogPosts"];
  var Page_Admin_Home = $PS["Page.Admin.Home"];
  ...
  var component = function (dictMonadAff) {
      return function (dictNavigate) {
          return function (dictManageBlogPost) {
              var render = function (v) {
                  if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Data_Route.Home) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "home";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Page_Home.component(dictManageBlogPost))(Data_Unit.unit)(Data_Void.absurd);
                  };
                  if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Data_Route.AdminHome) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "adminHome";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Page_Admin_Home.component)(Data_Unit.unit)(Data_Void.absurd);
                  };
                  if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Data_Route.AdminBlogPosts) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "adminBlogPosts";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Page_Admin_BlogPosts.component(dictManageBlogPost)(dictMonadAff.MonadEffect0())(dictNavigate))(Data_Unit.unit)(Data_Void.absurd);
                  };
                  if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Data_Route.AdminBlogPost) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "adminBlogPost";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Page_Admin_BlogPost.component(dictManageBlogPost)(dictNavigate))({
                          blogPostId: v.route.value0.value0
                      })(Data_Void.absurd);
                  };
                  ...
                  throw new Error("Failed pattern match at Component.Router (line 71, column 22 - line 82, column 59): " + [ v.route.constructor.name ]);
              };
              var handleQuery = function (v) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Route.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $21 = {};
                          for (var $22 in v2) {
                          ...
                          $21.route = new Data_Maybe.Just(v.value0);
                          return $21;
                      })))(function () {
              ...
              var handleAction = function (v) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                      var $29 = Routing_Duplex.parse(Data_Route.routeCodec);
                      return function ($30) {
                          return Data_Either.hush($29($30));
                      };
                      ...
                      return Capability_Navigate.navigate(Capability_Navigate.navigateHalogenM(dictNavigate))(Data_Maybe.fromMaybe(Data_Route.Home.value)(v1));
                  });
              };
              return Halogen_Component.mkComponent({
                  initialState: function (v) {
...
(function($PS) {
  ...
  exports["environment"] = $foreign.environment;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Data.Environment"] = $PS["Data.Environment"] || {};
  var exports = $PS["Data.Environment"];                   
  var Development = (function () {
      function Development() {

      };
      Development.value = new Development();
      return Development;
  })();
  ...
  var toEnvironment = function (v) {
      if (v === "Production") {
          return Production.value;
      };
      return Development.value;
  };
  exports["toEnvironment"] = toEnvironment;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Environment = $PS["Data.Environment"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Route = $PS["Data.Route"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      var environ = Data_Environment.toEnvironment(Config.environment);
      var env = {
          environment: environ,
          apiURL: Config.apiURL
      };
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(env))(Component_Router.component(AppM.monadAffAppM)(AppM.navigateAppM)(AppM.manageBlogPostAppM));
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(Data_Route.routeCodec))(function (old) {
              return function ($$new) {
                  return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(v1.query(Halogen_Query.tell(Component_Router.Navigate.create($$new)))));
              };
          }))))(function () {
