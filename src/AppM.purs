...
instance manageBlogPostAppM :: ManageBlogPost AppM where
  getBlogPosts pagination   = pure []
  getBlogPost postId        = pure Nothing
  createBlogPost post       = pure Nothing
  updateBlogPost post       = pure Nothing
  deleteBlogPost post       = pure unit
